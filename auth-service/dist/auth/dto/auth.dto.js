...
const is_valid_email_domain_validator_1 = require("../../validators/is-valid-email-domain.validator");
...
__decorate([
    ...
    (0, class_validator_1.Validate)(is_valid_email_domain_validator_1.IsValidEmailDomain),
    __metadata("design:type", String)
